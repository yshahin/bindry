...
export function inferDirectionFromFilename(fileName = '') {
 ...
 * @param {string} [fileName] - Optional original file name for fallback detection
 * @returns {Promise<'ltr'|'rtl'|'unknown'>} The detected text direction
 */
